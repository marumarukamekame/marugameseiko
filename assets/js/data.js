window.SITE_DATA = {
  ...
  activities: [
    { title: "いざ検診", subtitle: "定期的な地域総合スクリーニング", summary: "身近な場所で健康を見つめ直すきっかけをつくり、地域の皆さまと健やかな暮らしを考える活動です。", image: "/marugameseiko/assets/images/digital-health-scale.svg", imageAlt: "明るい空間で62.4キログラムを表示する白いデジタル体重計" },
